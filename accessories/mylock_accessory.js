...
var relayPin = 36; //Physical Pin Number for the relay you wish to be able to use. Change as you desire...



var LightController = {

  name: "Lock", //name of accessory

  pincode: "031-45-154",

  username: "FL:3O:CK:5A:1A:1A", // MAC like address used by HomeKit to differentiate accessories.

  manufacturer: "DARSHIL", //manufacturer (optional)

  model: "v2.0", //model (optional)

  serialNumber: "A12S345KDD", //serial number (optional)
